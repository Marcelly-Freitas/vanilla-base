const r=`<div class="flex flex-col gap-6 registration-page">\r
    <div class="title">\r
        <div>\r
            <h1>Matricular aluno</h1>\r
        </div>\r
    </div>\r
\r
    <div class="flex flex-col gap-4">\r
        <label class="text-primary font-bold text-sm">Pesquisar turma disponível</label>\r
\r
    ...
    <div class="card">\r
        <div class="flex flex-col gap-4">\r
            <div class="lista-wrapper">\r
                <h4 class="attendance-empty-title">Utilize os filtros acima para pesquisar uma turma</h4>\r
            </div>\r
        </div>\r
    </div>\r
