const r=`<div class="page-wrapper">\r
    <div class="flex justify-between gap-4 items-center">\r
        <h1 class="text-primary">Editar Aluno</h1>\r
\r
...
\r
            <div class="form-col-2">\r
                <div class="form-group">\r
                    <button class="btn" type="button" onclick="navigateToRoute(event, '/aluno/lista')">Cancelar</button>\r
                </div>\r
                <div class="form-group">\r
                    <button class="btn btn-primary" type="submit">Atualizar</button>\r
                </div>\r
            </div>\r
        </form>\r
    </div>\r
